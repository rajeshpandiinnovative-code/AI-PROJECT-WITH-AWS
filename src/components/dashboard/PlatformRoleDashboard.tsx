  ...
  return (
    <div className="min-h-screen bg-[#0F172A] text-zinc-100">
      ...
      <main className="mx-auto max-w-5xl px-4 py-10 sm:py-14">
        ...
        <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">{roleLabel}</h1>
        ...
        <div className="mt-4 rounded-xl border border-slate-700 bg-[#1E293B] px-4 py-3 text-sm text-slate-300">
          ...
          <p className="mt-2 text-slate-400">
            {demo ? (
              ...
              <>
                Set board, role, and location on the{" "}
                <Link href="/login" className="text-cyan-400 underline">
                  login
                </Link>{" "}
                page (demo dropdowns). Charts below use illustrative data until you link a school.
              </>
            )}
          </p>
        </div>
